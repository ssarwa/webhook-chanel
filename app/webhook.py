...
def json_convert_vulndb_to_cve(report, report_name):
    ...
    for item in report:
        ...
        csv_data_dict["CVSS v2 vector"] = item["vulnCvss2Score"]
        csv_data_dict["CVSS v2 base score"] = item["vulnCvss2Vector"]
        csv_data_dict["CVSS v3 vector"] = item["vulnCvss3Score"]
        csv_data_dict["CVSS v3 base score"] = item["vulnCvss3Vector"]
